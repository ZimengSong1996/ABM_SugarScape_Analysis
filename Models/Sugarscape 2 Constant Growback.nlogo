...
to turtle-setup ;; turtle procedure
  ...
  set sugar random-in-range 350 400
...
@#$#@#$#@
<experiments>
  <experiment name="initial-wealth" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="metabolism" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <metric>calculate-gini-index</metric>
  ...
  <experiment name="vision" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <metric>calculate-gini-index</metric>
